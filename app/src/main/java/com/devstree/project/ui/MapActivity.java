                ...
                if (latLngArrayList.size() > 1) {
                    if (latLngArrayList.size() > 2 && j > 1) {
                        Routing routing = new Routing.Builder()
                                ...
                                .waypoints(new LatLng(latLngArrayList.get(j - 1).latitude, latLngArrayList.get(j - 1).longitude), new LatLng(latLngArrayList.get(j).latitude, latLngArrayList.get(j).longitude))
                                .key("AIzaSyBSNyp6GQnnKlrMr7hD2HGiyF365tFlK5U")  //also define your api key here.
                                .build();
                        routing.execute();
                    } else {
                        if (latLngArrayList.size() == 2) {
                            Routing routing = new Routing.Builder()
                                    ...
                                    .withListener(this)
                                    .alternativeRoutes(true)
                                    .waypoints(new LatLng(latLngArrayList.get(0).latitude, latLngArrayList.get(0).longitude), new LatLng(latLngArrayList.get(1).latitude, latLngArrayList.get(1).longitude))
                                    .key("AIzaSyBSNyp6GQnnKlrMr7hD2HGiyF365tFlK5U")  //also define your api key here.
                                    .build();
                            routing.execute();
                        } else {
                            Routing routing = new Routing.Builder()
                                    ...
                                    .withListener(this)
                                    .alternativeRoutes(true)
                                    .waypoints(new LatLng(latLngArrayList.get(j).latitude, latLngArrayList.get(j).longitude), new LatLng(latLngArrayList.get(j + 1).latitude, latLngArrayList.get(j + 1).longitude))
                                    .key("AIzaSyBSNyp6GQnnKlrMr7hD2HGiyF365tFlK5U")  //also define your api key here.
                                    .build();
                            routing.execute();
                        }
                    ...
                    if (latLngArrayList.size() == 1) {
                        Routing routing = new Routing.Builder()
                                ...
                                .withListener(this)
                                .alternativeRoutes(true)
                                .waypoints(new LatLng(latLngArrayList.get(0).latitude, latLngArrayList.get(0).longitude), new LatLng(latLngArrayList.get(0).latitude, latLngArrayList.get(0).longitude))
                                .key("AIzaSyBSNyp6GQnnKlrMr7hD2HGiyF365tFlK5U")  //also define your api key here.
                                .build();
                        routing.execute();
                    }
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        ...
        for (int i = 0; i < route.size(); i++) {
            ...
            if (i == shortestRouteIndex) {
                ...
                startMarker.title(latLngArrayList.get(i).title);
                mMap.addMarker(startMarker);

                MarkerOptions endMarker = new MarkerOptions();
                endMarker.position(polylineEndLatLng);
                endMarker.title(latLngArrayList.get(latLngArrayList.size() - 1).title);
